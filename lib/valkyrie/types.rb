...
module Valkyrie
  ...
  module Types
    ...
    Valkyrie::Types::Integer = Dry::Types["integer"]
    Valkyrie::Types::Coercible::Integer = Dry::Types["coercible.integer"]
    Int = Dry::Types["integer"].constructor do |value|
      warn "[DEPRECATION] Valkyrie::Types::Int has been renamed in dry-types and this " \
           ...
           "Called from #{Gem.location_of_caller.join(':')}"
      Dry::Types["integer"][value]
    end
    Coercible::Int = Dry::Types["coercible.integer"].constructor do |value|
      warn "[DEPRECATION] Valkyrie::Types::Coercible::Int has been renamed in dry-types and this " \
           ...
           "Called from #{Gem.location_of_caller.join(':')}"
      Dry::Types["coercible.integer"][value]
    end
  end
end
